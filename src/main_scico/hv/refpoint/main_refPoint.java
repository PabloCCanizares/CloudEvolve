...
public class main_refPoint {
    ...
    public static void main(String[] args) {
        ...
        if (args != null && args.length > 0) {
            ...
            bases.add("/localSpace/cloudEnergy/cloudsimStorage/evolutionary/NSGAII/Bl_w3");
        ...
        CalculateRefPoint calc = new CalculateRefPoint(rootsList).withBanners(true);

        double[] q99 = calc.compute(); // q99[0]=energía, q99[1]=tiempo
