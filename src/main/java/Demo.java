...
public class Demo {
	...
	private static void addListener(GeneticAlgorithm<MyVector, Double> ga) {
		...
		ga.addIterationListener(new IterationListener<MyVector, Double>() {
	...
	public static class MyVectorFitness implements Fitness<MyVector, Double> {
		...
		@Override
		public Double calculate(Demo.MyVector chormosome, EGAObjectives obj) {
			// TODO Auto-generated method stub
			return null;
		}
	}
